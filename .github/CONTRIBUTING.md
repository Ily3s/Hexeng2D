...
You can find the doc of Hexeng2D at doc/html/index.html (from the root of this repo). For the moment, the doc is very simple but it can help.
...
If you have any questions, my [Discord](discord.com/invite/GtPk7mr6Ps) is made for that.
Note that my dms are open, that's the fastest way to get an answer from me.
