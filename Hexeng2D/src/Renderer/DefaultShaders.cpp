...
namespace Hexeng::Renderer
{
	...
	{ []() {
		...
		batching_shader_250 = Shader({ {ShaderType::VERTEX_SHADER, batching_vs}, {ShaderType::FRAGMENT_SHADER, batching_fs} });
		...
		batching_shader_250.add_necessary_uniforms();
