...
public :
	...
	DefaultButton(const std::u32string& str, std::function<void(void)> on_click, Hexeng::Vec2<int> pos,
...
private:
	...
	Hexeng::Vec2<int> m_pos{ 0, 0 }, m_size{ 0, 0 };
...
public :
	...
	Cursor(const std::u32string& str, float* var, Hexeng::Vec2<int> pos, Hexeng::Vec2<int> size,
