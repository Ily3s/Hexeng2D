...
\DoxyHorRuler{0}
\hypertarget{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md1}{}\doxysection{Installation and Setup}\label{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md1}
...
\DoxyHorRuler{0}
\hypertarget{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md2}{}\doxysection{Features}\label{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md2}
...
\DoxyHorRuler{0}
\hypertarget{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md3}{}\doxysection{Contact \& Support}\label{md__c__dev_repos__hexeng2_d__r_e_a_d_m_e_autotoc_md3}
If you have any questions that concerns Hexeng2D, or if you\textquotesingle{}re getting a problem with it, you can contact me on my \href{discord.com/invite/GtPk7mr6Ps}{\texttt{ Discord}}. Note that my dms are open, that\textquotesingle{}s the fastest way you can get an answer from me. 